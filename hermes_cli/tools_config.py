...
_TOOLSET_PLATFORM_RESTRICTIONS: Dict[str, Set[str]] = {
    ...
    # Trusted delivery identity exists only on admitted Feishu gateway turns.
    # Runtime handlers still recheck ToolInvocationContext before every call.
    "video_knowledge_messaging": {"feishu"},
}
