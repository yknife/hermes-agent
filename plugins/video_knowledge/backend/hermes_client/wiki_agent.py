    ...
    def _load_skill(
        ...
        *,
        ...
        directive = (
            ...
            "only pages relevant to the question. Search uses literal keywords, not "
            "semantic questions: use one short keyword per search, at most 8 searches. "
            "Do not exhaustively enumerate synonyms. Select a few relevant pages, "
            "then read their cited original evidence and submit promptly. Respect the "
            "remaining read budget reported by tools. Submission is always available "
            "after the research budget is exhausted; explain missing evidence instead "
            "of retrying searches. User question: "
            f"{query_question}"
